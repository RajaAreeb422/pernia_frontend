...
const BillingData = props => {
 ...
 // else{
    u_info = {
      email: props.shipData.email,
      first_name: props.shipData.first_name,
      last_name: props.shipData.last_name,
      password: 'agag'
    }
    ...
    s_info = {
      id: '',
      name: props.shipData.first_name,
      mobile:'9363939370',
      phone: props.shipData.phone,
      user_address: props.shipData.address,
      country: props.shipData.country,
      province: props.shipData.state,
      city: props.shipData.city,
      postal_code: props.shipData.post_code,
    }
...
{bill==false && checked==false?
  <FormWithConstraints
   ...
   <hr/>
   <p>Email</p>
   <input  required onChange={handleBChange}
    className={`${chk.inputbox} form-control`} type='email' name='email'/>
   ...
   <p>First name</p>
   <input  required onChange={handleBChange}
    className={`${chk.inputbox} form-control`} type='text' name='first_name'/>
   <FieldFeedbacks for="first_name">
   <FieldFeedback style={{color:'red'}} when="*" />
          </FieldFeedbacks>
   <p style={{marginTop:'10px'}}>Last name</p>
   <input  required onChange={handleBChange}
  className={`${chk.inputbox} form-control`} type='text' name='last_name'/>
   ...
   <input  required onChange={handleBChange}
    className={`${chk.inputbox} form-control`} type='text' name='address'/>
   ...
   <input  required onChange={handleBChange}
   className={`${chk.inputbox} form-control`} type='text' name='country'/>
   <FieldFeedbacks for="country">
   <FieldFeedback style={{color:'red'}} when="*" />
          </FieldFeedbacks>
   <p style={{marginTop:'10px'}}>County / State / Province</p>
   <input  required onChange={handleBChange}
   className={`${chk.inputbox} form-control`} type='text' name='state'/>
   <FieldFeedbacks for="state">
   <FieldFeedback style={{color:'red'}} when="*" />
          </FieldFeedbacks>
   <p style={{marginTop:'10px'}}>City</p>
   <input  required onChange={handleBChange}
   className={`${chk.inputbox} form-control`} type='text' name='city'/>
   <FieldFeedbacks for="city">
   <FieldFeedback style={{color:'red'}} when="*" />
          </FieldFeedbacks>
   <p style={{marginTop:'10px'}}>Post Code</p>
   <input  required onChange={handleBChange}
   className={`${chk.inputbox} form-control`} type='text' name='post_code'/>
   ...
   <input  required onChange={handleBChange}
    className={`${chk.inputbox} form-control`} type='text' name='phone'/>
...
<button className={chk.nxt}>Place Order</button> 
